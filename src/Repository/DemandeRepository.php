...
public function findLatestForVendeurOccasion(string $zoneVendeur): array
{
    return $this->createQueryBuilder('d')
...
public function findAllForVendeurOcca(string $zoneVendeur): array
{
    return $this->createQueryBuilder('d')
        ->where('d.vendeuroccasion = 1')
        ->andWhere('d.zone = :zoneVendeur OR d.zone = :zoneTunisie')
...
public function filterDemandesvendeurOcca($marque = null, $zone = null, $date = null, $type = null): array
{
    $qb = $this->createQueryBuilder('d');
...
public function countDemandesDispoVendeurOcc(string $zoneVendeur): int
{
    return $this->createQueryBuilder('d')
        ->select('COUNT(d.id)')
        ->where('(d.zone = :zone OR d.zone = :toute)')
